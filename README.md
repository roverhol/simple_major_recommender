...
| `supplemental_lecture_lab_materials/` | Optional instructor drafts (Labs 1–4: learning outcomes + Lab 4 study-group mini-project). |
...
- **Supplemental materials:** See `supplemental_lecture_lab_materials/` for optional lab drafts (Labs 1–4, including the Lab 4 study-group mini-project); adapt or ignore depending on your syllabus.
