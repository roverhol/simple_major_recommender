...
| `supplemental_lecture_lab_materials/` | Optional drafts (Labs 1–5: learning outcomes + study-group mini-project Labs 4–5). |
...
- **Supplemental materials:** See `supplemental_lecture_lab_materials/` for optional lab drafts (Labs 1–5, including the study-group mini-project in Labs 4–5); adapt or ignore depending on your syllabus.
