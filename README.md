...
| `supplemental_lecture_lab_materials/` | Optional instructor drafts (currently Labs 1–3 learning outcomes). |
...
- **Supplemental materials:** See `supplemental_lecture_lab_materials/` for optional early-lab learning-outcome drafts (Labs 1–3); adapt or ignore depending on your syllabus.
